...
import org.morkato.bmt.api.validation.constraints.MorkatoModelAttribute;
import org.morkato.bmt.api.validation.constraints.MorkatoModelRoll;
...
import org.morkato.bmt.api.validation.groups.OnId;
...
public class GuildDTO extends DefaultDTO<GuildDTO> {
  ...
  public static GuildDTO from(GuildIdQuery query) {
    return new GuildDTO()
      .setId(query.id());
  }

  public static GuildDTO from(GuildCreateQuery query) {
    return new GuildDTO()
      .setId(query.getId())
