...
CREATE FUNCTION mcisidv1_gen(SMALLINT, regclass = 'mcisidv1snapshot'::regclass) RETURNS mcisidv1 AS 'MODULE_PATHNAME', 'pgmcisidv1Generate' LANGUAGE C STRICT;
